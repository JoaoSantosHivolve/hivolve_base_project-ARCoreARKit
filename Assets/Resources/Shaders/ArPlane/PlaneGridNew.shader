    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float distanceFromObject = distance(i.worldPos, _Position);
                float fade = saturate(1 - clamp(distanceFromObject, 0,_MaxDistance) / _MinDistance);

                return fixed4(_GridColor.rgb, (col.r * i.color.a) * fade);
            }
            ENDCG
        }
    }
